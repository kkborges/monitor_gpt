...
- Em Linux desktop, alguns plugins de voz podem não ter implementação oficial. O app já desativa voz automaticamente e mantém chat por texto.
- O erro de `RawKeyboard ... Scroll Lock` é um problema conhecido no framework/GTK e não é causado pelo código do app.
